...
//SHOW SOLVED QUIZES
//store.dispatch(api.endpoints.updatesForOpenQuizes.initiate({}) for openquizes
        ...
        fetchOpenQuizesArray: builder.query({
            async queryFn() {
              ...
              //      let quizes;
                    ...
                    let res = await timeout(275, pageQuizesSets);
...
function handleCheckAnswer(e) {
    ...
    let { title, theme, answers, text, type, answer, hint = "" } = resOpenQuizesArray.data[activePage];
...
async function initialLoad() {
    ...
    //         header: "Тест",
    //         title: "Балансовые уравнения 1",
    //         theme: "Основы бухгалтерского учета",
    //         text: `
    ...
    //           Бухгалтер выполнил запись  Дт А1 Кт А4 на Х руб. Это операция`,
    //         choices: [
    //             "А+Х, А-Х",
    //             "А+Х, П+X",
    //             "А-Х, П-Х",
    ...
    //         ],
    //         answers: ["А+Х, А-Х"],
    //         //  hint: "Д расчетный счет (405, 406, 407, 408) К 30109 "
    //     },
    // };
    //     window.quizesSets.forEach(item => {
...
initialLoad().then(() => { renderPagination() });
