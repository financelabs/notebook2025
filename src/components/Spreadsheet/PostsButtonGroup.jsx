...
import ShowXlTableArrayOfArrays from "../../original/mediatemplates/ShowXlTableArrayOfArrays";
import { useFirebaseNode } from "../../original/hooks/useFirebaseNode";
...
export default function PostsButtonGroup() {
    ...
    let { expandView, email, quizString, title, answer, answerIsRigh } = state;
...
function SavePostModal(props) {
    ...
    let { user, email, avatarUrl, spreadsheetContent } = state;
                ...
                {editPostTitleComment ? (
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <ShowXlTableArrayOfArrays xlArray={createProtoArray(spreadsheetContent)} />
...
function SelectAndOpenModal(props) {
    ...
    const { data: userPosts, loading, error } = useFirebaseNode(
        "usersCraft/" + state?.userEmail + "/posts/"
    );
