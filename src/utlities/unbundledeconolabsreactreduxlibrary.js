...
function transactionsListFull(bookrecords) {
  ...
  function App() {
    ...
    console.log("Econolabs Library");
    return (React.createElement("div", null,
        React.createElement("p", null,
            "Count: ",
            count),
        React.createElement("button", { class: "btn btn-sm", onClick: increment }, "Increment"),
        React.createElement("button", { class: "btn btn-sm", onClick: decrement }, "Decrement")));
}
