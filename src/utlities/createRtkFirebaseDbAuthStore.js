...
function doAuthUser(e) {
    e.preventDefault();
    console.log("Do Auth");
    let formData = new FormData(document.getElementById("authform"));
    let res = {};
    for (const [key, value] of formData) {
        res[key] = value
    }
    console.log(res);
    doSignInWithEmailAndPassword(res.emailInput, res.passwordInput)
        .then(res => {
            console.log(res);
...
document.getElementById("authformbutton").addEventListener("click", (e) => doAuthUser(e), false);
document.getElementById("quizButton").addEventListener("click", (e) => signOut(auth), false);
...
function createRtkFirebaseDbAuthStore() {    
...
export default createRtkFirebaseDbAuthStore
