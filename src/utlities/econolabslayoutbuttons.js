...
class EcomolabsLayoutButtons {
    constructor(selector, buttonsProps, callBack) {
        this.buttonsSelector = $$(`.${selector}`);
        this.buttonsProps = buttonsProps
    }

       addEvents() {
          console.log(this.buttonsSelector);
       }

}


export default EcomolabsLayoutButtons
