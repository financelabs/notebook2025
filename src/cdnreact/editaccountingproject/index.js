...
function App() {
    ...
    useEffect(() => {
        async function getUser() {
            ...
            let updates = {};
            updates["/openquiz/taxaccounting3"] = {
                id: "taxaccounting3",
                title: "Налоги и налоговый учет в организации 3",
                ...
                periods: ["4 кв. 2024", "1 кв. 2025", "2 кв. 2025", "3 кв. 2025" ],
                tasks: [
                    {
                        id: 0,
                        text: `Компания организована в 2024 году. Сформирован и оплачен уставный капитал.<br>`
                    },

                     {
                        id: 1,
                        text: `1 кв. 2025 приобретены и оплачены товары 1000 ед. на сумму 120 000 руб., в том числе НДС 20%<br> `
                    },


                    {
                        id: 2,
                        text: `2 кв. 2025 Продано 600 ед. Выручка от продаж 108 000 руб, в томч числе НДС 20%<br>`
                    },

                     {
                        id: 3,
                        text: `3 кв. 2025 Продано 400 ед. Выручка от продаж 72 000 руб, в томч числе НДС 20%<br>`
                    },
