...
function App() {
    ...
    useEffect(() => {
        async function getUser() {
            ...
            let updates = {};
            updates["/openquiz/accountingreports4"] = {
                id: "accountingreports4",
                title: "Бухгалтерская финансовая отчетность",
                theme: "БФО",
                ...
                tasks: [
                    {
                        id: 0,
                        text: `Компания организована в 2023 году. Сформирован и оплачен уставный капитал. Получен кредит. Приобретены и оплачены основные средства.<br>`
                    },

                    {
                        id: 1,
                        text: `Выручка от продаж по годам - за 2024 10000, 2025 20000, 2026 12000.<br>`
                    },

                     {
                        id: 2,
                        text: `Себестоимость проданных товаров по годам - 50% от выручки.<br>`
                    },

                     {
                        id: 3,
                        text: `Приобретены и оплачены товары. В первый год приобретены с учетом страхового запаса на 1000.<br> `
                    },

                     {
                        id: 4,
                        text: `Оплачена выручка - поступление от покупателей. В первый год нам заплатили меньше на 2000.<br> `
                    },

                     {
                        id: 5,
                        text: `Начислена и выплачена заработная плата - 20% от выручки. Относится на управленческие (общехозяйственные) расходы<br> `
                    },

                     {
                        id: 6,
                        text: `Начислены и выплачены страховые платежи - 6% от выручки. Относятся на управленческие (общехозяйственные) расходы<br> `
                    },

                     {
                        id: 7,
                        text: `Начислены расходы на рекламу - 4% от выручки. Относятся на коммерческие расходы (расходы на продажу)<br> `
                    },

                     {
                        id: 8,
                        text: `Начислена амортизация 100 в год. Относится на управленческие расходы (общехозяйственные)<br> `
                    },

                    {
                        id: 9,
                        text: `Списаны коммерческие и управленческие расходы (закрыты счета 26 и 44)<br> `
                    },

                    
                      {
                        id: 10,
                        text: `Начислены и уплачены проценты по кредиту - 30% от остатка на начало года<br> `
                    },

                  
                      {
                        id: 11,
                        text: `Преполагаем, что в году только один месяц. Закрыты счета 90, 91 и 99<br> `
                    },

                      
                      {
                        id: 12,
                        text: `Отстаток денег свыше 500 направляется на погашение долга по кредиту и дивиденды<br> `
                    },
